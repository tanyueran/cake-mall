...
public class RsaUtil {
    ...
    public static PrivateKey getPrivateKey(String key) throws NoSuchAlgorithmException, InvalidKeySpecException {
        Base64 base64 = new Base64();
        byte[] decode = base64.decode(key);
        PKCS8EncodedKeySpec x509EncodedKeySpec = new PKCS8EncodedKeySpec(decode);
        KeyFactory keyFactory = KeyFactory.getInstance("RSA");
    ...
    public static void main(String[] args) throws Exception {
        ...
        String encrypt = RsaUtil.encrypt("as", map.get("public"));
        System.out.println(encrypt);
        String aPublic = RsaUtil.decrypt(encrypt, map.get("private"));
